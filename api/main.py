...
# Estas líneas se comentan porque UV maneja la ejecución del servidor  
# automáticamente con 'uv run uvicorn main:app --host 0.0.0.0 --port 8989 --reload'.  
# No es necesario iniciar manualmente el servidor en este archivo.  
